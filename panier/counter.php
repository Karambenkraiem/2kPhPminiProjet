<div>
    ...
    <?php if ($idUtilisateur !== 0): ?>
        <form method="post" class="counter d-flex" action="ajouter_panier.php">
            ...
            <input  class="form-control" style="text-align: center;" value="<?php echo $qty ?>" type="number" name="qty" id="qty" max="99">
    ...
    <?php else: ?>
        <div class="alert alert-warning" role="alert">
            Vous devez être connecté pour acheter ce produit <strong><a href="./traitement/connexion.php">Connexion</a></strong>
        </div>
    <?php endif; ?>
</div>